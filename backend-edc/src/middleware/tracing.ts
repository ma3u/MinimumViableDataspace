/**
 * OpenTelemetry Tracing Setup for Backend-EDC
 * 
 * Provides distributed tracing with automatic instrumentation
 * for Express HTTP requests and external HTTP calls to EDC.
 */
...
import { trace, SpanStatusCode, Span, context as otelContext, propagation } from '@opentelemetry/api';

const SERVICE_NAME = 'backend-edc';
